#!/usr/bin/env python3
"""
Score 3 candidate "second worked example" multidomain proteins for Figure 4
(EGFR, FAK1, PIK3CA) against layer-25 ("display layer 26") CAVs from the
20k-motif library. User will pick one after seeing a draft with all three.
"""
import json
import sys
...
OUT_JSON = DATA_DIR / "candidates_fig4b_scores.json"

HS_INDEX = 25
BOS_OFFSET = 1

WINDOW_LENGTHS = {
    "PF01030": 113, "PF00757": 152, "PF14843": 123, "PF21314": 36, "PF07714": 254,
    "PF18038": 96, "PF00373": 111, "PF21477": 95, "PF03623": 132,
    "PF02192": 75, "PF00794": 99, "PF00792": 118, "PF00613": 175, "PF00454": 210,
}
...
def main():
    records = json.loads((DATA_DIR / "candidates_fig4b.json").read_text())
    ...
    for acc, rec in records.items():
        ...
        print(f"{acc}: {len(protein_result['domains'])} domains scored", file=sys.stderr)
